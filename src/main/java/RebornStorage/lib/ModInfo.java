...
public class ModInfo
{
    ...
    public static final String MOD_DEPENDENCUIES ="required-after:reborncore;after:refinedstorage";
    public static final String COMMON_PROXY_LOC = "RebornStorage.proxys.CommonProxy";
